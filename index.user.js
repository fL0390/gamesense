...
// @version      1
// @description  Hide and remove Cyrillic text in gamesense.pub shoutbox and change username
// @author       fL
// @match        *://gamesense.pub/*
// @grant        none
// ==/UserScript==
...
(function() {
    ...
    function createSettingsModal() {
        ...
        modal.style.backgroundImage = "url('https://i.imgur.com/cUHelzE.png')";
    ...
    function addSettingsButton() {
        if (window.location.pathname === '/forums/index.php') {
    ...
    function replaceCyrillicMessages() {
        ...
        messages.forEach(message => {
            if (containsCyrillicInMessage(message.innerText)) {
                message.innerHTML = '<img src="https://i.imgur.com/8JrzjeO.png" width=200 height=200>';
            }
        });
    }
